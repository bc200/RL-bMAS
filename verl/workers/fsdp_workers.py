...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        if self._is_actor:
            ...
            #print(f"ppo_mini_batch_size after multiplying rollout.n: {self.config.actor.ppo_mini_batch_size}")
            self.config.actor.ppo_mini_batch_size //= self.device_mesh.size() // self.ulysses_sequence_parallel_size
            #print(f"ppo_mini_batch_size after normalization: {self.config.actor.ppo_mini_batch_size}")
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        print(f"rollout dp: {dp}, infer_tp: {infer_tp}")
        ...
        if rollout_name == "hf":
            ...
            if vllm_mode == "customized":
                ...
                #print("config.rollout:", self.config.rollout)
