...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> Dict[str, Any]:
    ...
    metrics = {
        ...
        **(
        ...
        #agent token
        "agent/total_input_token_num":
            batch.non_tensor_batch["total_input_token_num"][0].item(),
        "agent/total_output_token_num":
            batch.non_tensor_batch["total_output_token_num"][0].item(),
        "agent/total_token_num":
            batch.non_tensor_batch["total_input_token_num"][0].item() + batch.non_tensor_batch["total_output_token_num"][0].item(),
